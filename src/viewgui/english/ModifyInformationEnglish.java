 ...
 * 修改信息界面
 * */
public class ModifyInformationEnglish extends JFrame{
    /*
     * 两个标签     用户名
     * 一标签    一文本框     学号
     * 一标签    一文本框      姓名
    ...
    private JLabel jLabel3 = new JLabel("ID：");
    ...
    public ModifyInformationEnglish(String user) {
        setSize(600, 450);
