...
public class ModifyBookEn extends JFrame{
    // 面板
    private JPanel jPanel = new JPanel();
    // 标签
    private JLabel jLabel = new JLabel("ModifyBookInfo");
    ...
    private JLabel jLabel6 = new JLabel("Status：");
    ...
    public ModifyBookEn() {
        ...
        jLabel2.setBounds(105, 250, 250, 30);

        jLabel3.setFont(font2);
        jLabel3.setBounds(105, 300, 250, 30);

        jLabel4.setFont(font2);
        jLabel4.setBounds(125, 350, 250, 30);

        jLabel5.setFont(font2);
        jLabel5.setBounds(105, 400, 250, 30);
