 ...
 * 管理员借书记录页面
 */
public class AdminBorrowEn extends JFrame {
    /*
     *  表格
     *
     * 下拉框 文本框 按钮
    ...
    public AdminBorrowEn() {
        ...
        button.setBounds(590, 173, 120, 35);
        ...
        model.addColumn("BorrowData", new Vector<Integer>());
        model.addColumn("ReturnData", new Vector<Integer>());
